...
export const DIALOG_API_ROWS: readonly ApiTableRow[] = [
  ...
  },
  {
    ...
    defaultValue: '-',
    description:
      'Mirrors KuiDialogConfig.closable. Informational only -- the container renders .kui-dialog-close itself when true.',
  },
  {
  ...
  },
  {
    ...
    defaultValue: 'true',
    description:
      'Shows the .kui-dialog-close button the container renders automatically, absolutely positioned top-right of the panel.',
  },
  {
