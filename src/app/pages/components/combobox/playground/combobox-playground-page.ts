...
import { PlaygroundControl, PlaygroundValues } from '../../../../shared/docs-ui/api-playground/playground-control';
...
@Component({
  ...
  imports: [ApiPlayground, ApiTable, KuiComboboxDirective, KuiDropdownComponent, KuiFieldComponent, KuiOptionDirective],
