...
export const COMBOBOX_API_ROWS: readonly ApiTableRow[] = [
  ...
  },
  {
    ...
    type: '(item: T) => string',
    defaultValue: 'String()',
    description: 'Maps a selected object value to display text. Required when T is not a primitive.',
  },
  {
    name: 'placeholder',
    type: 'string',
  ...
  },
  {
    ...
    type: 'boolean',
    defaultValue: 'false',
    description: 'Shows a suffix loader. Loading row content inside kui-dropdown is projected by the consumer.',
  },
  {
    name: 'disabled',
    type: 'boolean',
  ...
  },
  {
    ...
    type: 'boolean',
    defaultValue: 'false',
    description: 'Applies ARIA invalid state. kui-field also contributes invalid state from validation.',
  },
  {
    name: 'errors',
    type: 'readonly ValidationError[]',
    defaultValue: '[]',
    description: 'Validation errors set by [formField], consumed by kui-field for automatic error text.',
  },
  {
    name: 'touched',
    type: 'boolean',
  ...
  },
  {
    ...
    type: 'output: void',
    defaultValue: '-',
    description: 'Emitted when an opened dropdown closes; marks the control touched for Signal Forms.',
  },
  {
    name: 'id',
  ...
  },
  {
    ...
    type: 'directive',
    defaultValue: '-',
    description: 'Marks a projected option inside kui-dropdown. Provides role="option", aria-selected, disabled state, and keyboard navigation.',
  },
  {
    name: 'kuiComboboxHighlight',
    type: `pipe: (label: string, query: string | null | undefined) => readonly { text: string; match: boolean }[]`,
    defaultValue: '-',
    description: 'Splits an option label into plain and matched segments for highlighting the current query.',
  },
  {
    name: 'kuiProvideComboboxOptions',
    type: '(opts: KuiComboboxOptions) => Provider',
    defaultValue: '-',
    description: 'Registers app-wide combobox defaults, such as clearable, via KUI_COMBOBOX_OPTIONS.',
  },
  {
    name: 'KUI_COMBOBOX_OPTIONS',
    type: 'InjectionToken<KuiComboboxOptions>',
    defaultValue: '-',
    description: 'Injection token backing kuiProvideComboboxOptions. Read by the directive for clearable fallback.',
  },
  {
