...
> Angular component library documentation and external consumer verification.
...
- [Typography](https://kikita-labs.github.io/kikita-ui-docs/llms/foundations/typography.md): Semantic type-role classes, text tones, and the kuiText directive.
...
- [Card](https://kikita-labs.github.io/kikita-ui-docs/llms/components/card.md): Surface, elevated, and sunken content container.
- [Checkbox](https://kikita-labs.github.io/kikita-ui-docs/llms/components/checkbox.md): Native checkbox styling with field state integration.
- [Chip](https://kikita-labs.github.io/kikita-ui-docs/llms/components/chip.md): Compact token for selected values, filters, and entity references.
- [Color Input](https://kikita-labs.github.io/kikita-ui-docs/llms/components/color-input.md): Color value input.
- [Combobox](https://kikita-labs.github.io/kikita-ui-docs/llms/components/combobox.md): Searchable input with projected options and async mode.
...
- [Field](https://kikita-labs.github.io/kikita-ui-docs/llms/components/field.md): Label, hint, error, and form-control composition.
- [File Upload](https://kikita-labs.github.io/kikita-ui-docs/llms/components/file-upload.md): Controlled file picker.
- [Group](https://kikita-labs.github.io/kikita-ui-docs/llms/components/group.md): Grouped control chrome for adjacent actions and fields.
...
- [Tabs](https://kikita-labs.github.io/kikita-ui-docs/llms/components/tabs.md): Line and pill tab navigation with optional panel wiring.
- [Textarea](https://kikita-labs.github.io/kikita-ui-docs/llms/components/textarea.md): Native multiline input styling with field integration.
- [Toast](https://kikita-labs.github.io/kikita-ui-docs/llms/components/toast.md): Global notifications with actions and live-region semantics.
- [Tooltip](https://kikita-labs.github.io/kikita-ui-docs/llms/components/tooltip.md): Hover and focus hint.
- [Tree](https://kikita-labs.github.io/kikita-ui-docs/llms/components/tree.md): Hierarchical list.
